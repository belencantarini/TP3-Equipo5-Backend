...
async function actualizarPaciente(req, res) {
  try {
    ...
    pacientes[index] = { ...pacientes[index], nombre, apellido, dni, email, telefono, obraSocial, nroAfiliado, fechaNacimiento }
    await escribirData("pacientes", pacientes)
...
module.exports = { listarPacientes, crearPaciente, obtenerPaciente, actualizarPaciente, eliminarPaciente }
